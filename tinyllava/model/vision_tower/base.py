...
from transformers.models.beit.modeling_beit import BeitEmbeddings
...
class VisionTower(nn.Module):
    ...
    def _load_model(self, vision_tower_name, **kwargs):
        ...
        # self._vision_tower = self._vision_tower.half()
    ...
    def forward(self, x, **kwargs):
        if isinstance(self._vision_tower, BeitEmbeddings):
            image_features, _ = self._vision_tower(x)
        else:
